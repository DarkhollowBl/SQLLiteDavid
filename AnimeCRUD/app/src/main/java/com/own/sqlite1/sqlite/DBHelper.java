...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(String.format(
                ...
                BaseColumns._ID,
                Contract.Animes.ID,
                Contract.Animes.NAME,
                Contract.Animes.CREATOR,
                Contract.Animes.GENDER,
                Contract.Animes.YEAR,
                Contract.Animes.CHAPTERS));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //ANIME
        db.execSQL("DROP TABLE IF EXISTS "+ Tables.ANIME);
        onCreate(db);
